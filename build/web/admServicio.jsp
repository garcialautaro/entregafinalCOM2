    ...
    <footr>
        <div class="footer ">
            <div class="container"> <h2 style="color:white"> </h2>
                <div class="row"> <h2 style="color:white"> LISTA DE SERVICIOS</h2>
                    <div class="col-md-12">
                        ...
                        <table>
                            <thead>
                                <tr class ="contact_bg">
                                    ...
                                    <th class="container" id="fila1">Costo</th>
                                    <th class="container" id="fila1">Descripcion</th>
                                    <th class="container" id="fila1">Destino</th>
                                    <th class="container" id="fila1">Fecha</th>
                                    <th class="container" id="fila1">Tipo</th>
                                    <th class="container" id="fila4">Modificar</th>
                                    <th class="container" id="fila5">Eliminar</th>
                                </tr>
                            </thead>
                            <tbody>
                                <%
                                ...
                                %>
                                <tr class ="contact_bg">
                                    <%  Integer codigoServicio = serv.getCodigoServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=codigoServicio%> 
                                    </td>
                                    <%  String nombreServicio = serv.getNombreServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=nombreServicio%> 
                                    </td>
                                    <%  Double costoServicio = serv.getCostoServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=costoServicio%> 
                                    </td>
                                    <%  String descripcionServicio = serv.getDescripcionServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=descripcionServicio%> 
                                    </td>
                                    <%  String destinoServicio = serv.getDestinoServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=destinoServicio%> 
                                    </td>
                                    <%  Date fechaServicio = serv.getFechaServicio();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=fechaServicio%> 
                                    </td>
                                    <%
                                    String nombreTipoServ = null;
                                    for(TipoServicio tipoServ:listaTipoServicios) {
                                        if(tipoServ.getCodTipoServicio()==serv.getTipoServicio().getCodTipoServicio()){
                                        nombreTipoServ = tipoServ.getNombreTipoServicio();
                                        }
                                    }
                                     %> 
                                    <td class="container" id="fila1" style="color:white"> 
                                    ...
                                    <td class="container" id="fila4" style="color:white">
                                        <form name ="frmModificarServicio" action="SvModificarServicio" method="POST" style="display:inline">
                                            <input type="hidden" name="idServicio" value="<%=codigoServicio%>">
                                            <button type="submit" class="submit" data-title="Edit" style="display:inline">¿?</button>
                                        </form>
                                    </td>
                                    <td class="container" id="fila5" style="color:white">
                                        <form name ="frmEliminarServicio" action="SvEliminarServicio" method="POST" style="display:inline">
                                            <input type="hidden" name="idServicio" value="<%=codigoServicio%>">
