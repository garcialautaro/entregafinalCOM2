    ...
    <footr>
        <div class="footer ">
            <div class="container"> <h2 style="color:white"> </h2>
                <div class="row"> <h2 style="color:white"> LISTA DE VENDEDORES</h2>
                    <div class="col-md-12">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr class ="contact_bg">
                                    ...
                                    <% Integer idVendedor = ve.getIdVendedor();%>
                                    <td class="container" id="fila3" style="color:white">
                                        <%=idVendedor%> 
                                    </td>
                                    <td class="container" id="fila4" style="color:white">
                                        <form name ="frmModificarVendedor" action="SvModificarVendedor" method="POST" style="display:inline">
                                    ...
                                    <td class="container" id="fila5" style="color:white">
                                        <form name ="frmEliminarVendedor" action="SvEliminarVendedor" method="POST" style="display:inline">
                                            <input type="hidden" name="idVendedor" value="<%=idVendedor%>">
