    ...
    <footr>
        <div class="footer ">
            <div class="container"> <h2 style="color:white"> </h2>
                <div class="row"> <h2 style="color:white"> LISTA DE CIENTES</h2>
                    <div class="col-md-12">
                        ...
                        <table>
                            <thead>
                                <tr class ="contact_bg">
                                    ...
                                    <th class="container" id="fila1">Id</th>
                            ...
                            <tbody>
                                ...
                                %>
                                <tr class ="contact_bg">
                                    <%  String nombreCliente = cli.getNombreCliente();%> 
                                    <td class="container" id="fila1" style="color:white"> 
                                        <%=nombreCliente%> 
                                    </td>
                                    <% String apellidoCliente = cli.getApellidoCliente();%> 
                                    <td class="container" id="fila2" style="color:white">
                                        <%=apellidoCliente%> 
                                    </td>
                                    <% Integer idCliente = cli.getIdCliente();%>
                                    <td class="container" id="fila3" style="color:white">
                                        <%=idCliente%> 
                                    </td>
                                    <td class="container" id="fila4" style="color:white">
                                        <form name ="frmModificarCliente" action="SvModificarCliente" method="POST" style="display:inline">
                                    ...
                                    <td class="container" id="fila5" style="color:white">
                                        <form name ="frmEliminarCliente" action="SvEliminarCliente" method="POST" style="display:inline">
                                            <input type="hidden" name="idCliente" value="<%=idCliente%>">
