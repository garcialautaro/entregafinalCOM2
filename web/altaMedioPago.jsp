        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2>ALTA DE UN MEDIO DE PAGO</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footr>
        <div class="footer ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form action="SvAltaMedioPago" method="POST" class="contact_bg">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <input class="contactus" placeholder="Nombre del Medio de Pago" type="text" name="nombreMP">
                                    </div>
                                    <div class="col-md-12">
                                        <input class="contactus" placeholder="Comision del Medio de Pago" type="text" name="comisionMP">
                                    </div>
