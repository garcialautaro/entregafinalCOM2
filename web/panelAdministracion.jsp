                                ...
                                <div class="limit-box">
                                    <nav class="main-menu ">
                                        <ul class="menu-area-main">
                                            ...
                                            <li class="active"> <a href="login.jsp">Panel ADM</a> </li>
                                        </ul>
                                    </nav>
                                </div> 
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <button class="send"> <a href="abmPersonas.jsp">ABM Personas</a></button>
                                        </div>
                                        <div class="copyright"></div>
                                        <div class="col-md-12">
                                            <button class="send"> <a href="abmServiciosPaquetes.jsp">ABM Servicios y Paquetes</a></button>
                                        </div>
                                        <div class="copyright"></div>
                                        <div class="col-md-12">
                                            <button class="send"><a href="abmVentas.jsp">ABM Ventas</a></button>
                                        </div>  
                                        <div class="copyright"></div>
                                        <div class="col-md-12">
                                            <button class="send"><a href="abmConfig.jsp">ABM Config</a> </button>
                                        </div>
                                        <div class="copyright"></div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <button class="send">
                                                <form action="SvLogout" method="GET" class="col-md-12">
