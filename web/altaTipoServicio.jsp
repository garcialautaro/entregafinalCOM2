        ...
        <div class="backgro_mh">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="heding">
                            <h2>ALTA DE UN TIPO DE SERVICIO</h2>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <footr>
        <div class="footer ">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <form action="SvAltaTipoServicio" method="POST" class="contact_bg">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        <input class="contactus" placeholder="Nombre Tipo Servicio" type="text" name="nombreTipoServicio">
                                    </div>                                
